...
(function() {
  var Crypto, Fs, Http, Https, MimeTypes, Path, QueryString, Url, accept, accept_encoding, accepted_image_mime_types, camo_hostname, content_length_limit, current_connections, debug_log, default_security_headers, error_log, finish, four_oh_four, hexdec, keep_alive, logging_enabled, max_redirects, port, process_url, server, shared_key, socket_timeout, started_at, total_connections, version,
  ...
  accept = process.env.CAMO_ACCEPT || void 0;

  accept_encoding = process.env.CAMO_ACCEPT_ENCODING || void 0;
  ...
  server = Http.createServer(function(req, resp) {
    ...
    if (req.method !== 'GET' || req.url === '/') {
      ...
      transferredHeaders = {
        ...
        'Accept': (ref = accept || req.headers.accept) != null ? ref : 'image/*',
        'Accept-Encoding': (ref1 = accept_encoding || req.headers['accept-encoding']) != null ? ref1 : '',
        "X-Frame-Options": default_security_headers["X-Frame-Options"],
        "X-XSS-Protection": default_security_headers["X-XSS-Protection"],
        "X-Content-Type-Options": default_security_headers["X-Content-Type-Options"],
        "Content-Security-Policy": default_security_headers["Content-Security-Policy"]
